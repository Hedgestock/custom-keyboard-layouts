...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, FR_LESS,        LSFT(FR_LESS),  RALT(FR_APOS),  RALT(FR_EQL),   RALT(FR_MINS),  RALT(FR_UNDS),                                  KC_TRANSPARENT, KC_KP_MINUS,    KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_KP_ASTERISK, KC_F12,
    RALT(FR_EGRV),  FR_DQUO,        FR_APOS,        FR_LPRN,        FR_RPRN,        FR_EQL,                                                                         KC_KP_PLUS,     KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_SLASH,    KC_TRANSPARENT,
    KC_TRANSPARENT, RALT(FR_UNDS),  LSFT(FR_COLN),  RALT(FR_LPRN),  RALT(FR_RPRN),  FR_ASTR,        RALT(KC_0),                                     KC_TRANSPARENT, FR_COLN,        KC_KP_1,        KC_KP_2,        KC_KP_3,        LSFT(FR_UGRV),  KC_TRANSPARENT,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, LCTL(KC_S),     LCTL(FR_Z),     LCTL(KC_Y),     LCTL(LSFT(KC_ESCAPE)),WEBUSB_PAIR,                              KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, LCTL(FR_A),     LCTL(KC_X),     LCTL(KC_C),     LCTL(KC_V),     LGUI(LSFT(KC_S)),                                                               KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
